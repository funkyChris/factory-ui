 ...
 */
package org.qualipso.factory.ui.core.membership.server;
...
import org.qualipso.factory.ui.core.membership.client.MembershipServlet;
...
public class MembershipServletImpl extends RemoteServiceServlet implements MembershipServlet {
    ...
    // Logger
    private static Log logger = LogFactory.getLog(MembershipServletImpl.class);
